...
function initClothingSizeChart() {
    ...
    if (closeBtn) {
        closeBtn.addEventListener('click', closeClothingSizeChart);
    }
    if (backdrop) {
        backdrop.addEventListener('click', closeClothingSizeChart);
    }
...
function initFootwearSizeChart() {
    ...
    if (closeBtn) {
        closeBtn.addEventListener('click', closeFootwearSizeChart);
    }
    if (backdrop) {
        backdrop.addEventListener('click', closeFootwearSizeChart);
    }
